...
from api.views import WishListCreate, CartCreate, RemoveFromWishList,\
    create_user, UserRegistration, UserList, CreateOrder, login_user, testlogin, HomePageView, HomePageView1, AboutPageView1,newBusiness, index15, AboutPageView15
...
urlpatterns = {
	...
	url('login15/$', auth_views.login, {'authentication_form': LoginForm},),
	#url('api/login15/home/$', HomePageView),
	#path('api/login15/home/', HomePageView1.as_view()),
	url(r'about/', AboutPageView1.as_view()),
	url(r'templist/', AboutPageView15.as_view()),
    url(r'getdata/', index15),
	url('home/', HomePageView1.as_view()),
	url('login55/',testlogin),
